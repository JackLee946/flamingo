...
CLoginDlg::CLoginDlg(CFlashIMClient* pFMGClient)
{
...
BOOL CLoginDlg::InitUI()
{
	...
	//m_lnkRegAccount.SetHyperLink(_T("http://zc.FlashIM.com/chs/index.html?from=client&ptlang=2052&ADUIN=0&ADSESSION=0&ADTAG=CLIENT.UTalk.4153_NewAccount_Btn.0"));
	...
	//m_lnkLostPwd.SetHyperLink(_T("http://aq.FlashIM.com/cn2/findpsw/findpsw_index?source_id=1003&ptlang=2052&aquin=123456"));
