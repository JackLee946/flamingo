...
BOOL CLoginSettingsDlg::InitUI()
{
	...
	strIniPath += _T("config\\FlashIM.ini");
	...
	CString strTemp;
	iniFile.ReadString(_T("server"), _T("server"), _T("FlashIM.hootina.org"), strTemp.GetBuffer(64), 64, strIniPath);
	...
	iniFile.ReadString(_T("server"), _T("fileserver"), _T("FlashIM.hootina.org"), strTemp.GetBuffer(64), 64, strIniPath);
	strTemp.ReleaseBuffer();
    ...
    iniFile.ReadString(_T("server"), _T("imgserver"), _T("FlashIM.hootina.org"), strTemp.GetBuffer(64), 64, strIniPath);
    strTemp.ReleaseBuffer();
