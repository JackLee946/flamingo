...
public class FlashIMApplication extends Application {
    public static String DEFAULT_APP_PATH = "/sdcard/FlashIM";
    public static String DEFAULT_USERS_PATH = "/sdcard/FlashIM/Users";
    public static String DEFAULT_LOG_PATH = "/sdcard/FlashIM/Logs";
    ...
    public static FlashIMApplication instance;
    ...
    public static FlashIMApplication getInstance() {
        return instance;
    }
}
